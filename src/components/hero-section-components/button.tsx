const HeroSectionButton = () => {
  return (
    <button className="group cursor-pointer relative w-56 h-11 bg-[linear-gradient(144deg,_#af40ff,_#5b42f3_50%,_#00ddeb)] text-white whitespace-nowrap flex flex-wrap rounded-full overflow-hidden">
